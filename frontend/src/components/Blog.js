...
import {Box,Avatar,Card,CardContent,CardHeader,CardMedia,IconButton,Typography} from '@mui/material'
...
const Blog = ({title,description,imageURL,userName,isUser,id}) => {
  ...
  return (
    <div>
      ...
      <CardHeader
        avatar={
          <Avatar className={classes.font} sx={{ bgcolor:"rgb(95, 92, 216)" }} aria-label="recipe">
            {userName.charAt(1)}
          </Avatar>
        }
        title={title}
