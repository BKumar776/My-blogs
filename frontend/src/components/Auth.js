    ...
    <div>
      <form onSubmit={handleSubmit}>
        ...
        {isSignup && 
          ...
          <Button type='submit' variant= "contained" sx={{borderRadius:2 ,marginTop:3}} color="primary">Submit</Button>
          <Button onClick={()=>{setIsSignup(!isSignup)}} sx={{borderRadius:2 ,marginTop:3}} >change to {isSignup ? "Login" : "Singup"}</Button>
        </Box>
      </form>
    </div>
  )
